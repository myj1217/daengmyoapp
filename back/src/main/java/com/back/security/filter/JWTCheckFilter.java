...
//        }
        ...
        if(path.startsWith("/animal/list")) {
            return true;
        }

        if(path.startsWith("/api/missing/")) {
            return true;
        }
        if(path.startsWith("/missing/list")) {
            return true;
        }
        if(path.startsWith("/missing/replies/")) {
            return true;
        }
        ...
        if(path.startsWith("/notice/list")) {
            return true;
        }
